...
class SupervisorActivosController extends Controller
{
     ...
     public function getAltasSupervisor(Request $request){
        ...
        left join saf_2011.dbo.inv_bodegas as b on b.bodega_id = af.bodega_id
    ...
    public function getBajasSupervisor(Request $request){
     ...
     //metodo para mostrar activos de tipo alta para supervisor
     public function getAltasSupervisorActivos(Request $request){
        $idSupervisor = $request["id"];
        ...
        left join saf_2011.dbo.inv_bodegas as b on b.bodega_id = af.bodega_id
        where af.estado = 'A' and af.estadoActivo = 'Activo'
        and u.jefe_inmediato = ".$idSupervisor."
        order by af_codigo_interno desc
        ");
    ...
    //metodo para mostrar activos de tipo traslado para supervisor
    public function getTrasladosSupervisorActivos(Request $request){
      $idSupervisor = $request["id"];
     ...
     //metodo para mostrar activos de tipo baja para supervisor
    public function getBajasSupervisorActivos(Request $request){
        $idSupervisor = $request["id"];
      ...
      //metodo para obtener conteo de badges en vista de administrador por supervisor de activos
      public function getConteoSupervisorActivos(Request $request){
        $idSupervisor = $request["id"];
        ...
        where af.estado = 'A' and af.estadoActivo = 'Activo' and uj.id = ".$idSupervisor.") as conteoAltas,
        ...
        inner join users us on us.id = af.codigo_asignado
		inner join users uj on uj.id = us.jefe_inmediato
        where af.estado = 'T' and af.estadoActivo = 'Activo' and uj.id = ".$idSupervisor.")
         as conteoTraslados,
         ...
         inner join users us on us.id = af.codigo_asignado
		 inner join users uj on uj.id = us.jefe_inmediato
         where af.estado = 'B' and af.estadoActivo = 'Activo' and uj.id = ".$idSupervisor.")
        as conteoBajas");
